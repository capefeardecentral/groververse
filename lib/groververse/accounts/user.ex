defmodule Groververse.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Groververse.Repo)
  ...
  """
  def valid_password?(%Groververse.Accounts.User{hashed_password: hashed_password}, password)
